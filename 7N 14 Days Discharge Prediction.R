...
#RVAR Parenteral.Nutrition -input -numeric -vector
...
#
#RVAR predicted.fit -output -numeric -vector  #Metric Expression: RScript<_RScriptFile="J:\Ashley\ICU Prediction\7N 14 Day Discharge Prediction.R", _InputNames=" Days.Since.Checkin, Last.Bedded.Service.Grouped, Critical.Care.Indicator, Subsequent.Indicator, Cardiovascular.dx.category, CCC.drugs.dx.category, Genetic.dx.category, GI.dx.category, Hem.imm.dx.category, Neonatal.dx.category, Neuro.dx.category, Renal.dx.category, Respiratory.dx.category, Technology.dependent.dx.category, Weeks.gestation.category, ArtLine.Indicator, CVL1.Indicator, ECMO.Indicator, Oxygen.Indicator, Vent.Indicator, IO.Difference.Category, Problem.Count, NPO.Indicator, Birthweight.categories, Parenteral.Nutrition, Albumin.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, C.Reactive.Protein.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, ESR.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, WBC.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, Weaning.Phase, Clonidine.Inter.Indicator, Diazepam.Inter.Indicator, Fentanyl.Inter.Indicator, Lorazepam.Inter.Indicator, Methadone.Inter.Indicator, Morphine.Inter.Indicator, Midazolam.Cont.Indicator, Intermittent.Sedative.Medication.Admin.Count, Major.Region", _WorkingDir="\\BI_ISD\BI_Share\Ashley\ICU Prediction">( Days.Since.Checkin, Last.Bedded.Service.Grouped, Critical.Care.Indicator, Subsequent.Indicator, Cardiovascular.dx.category, CCC.drugs.dx.category, Genetic.dx.category, GI.dx.category, Hem.imm.dx.category, Neonatal.dx.category, Neuro.dx.category, Renal.dx.category, Respiratory.dx.category, Technology.dependent.dx.category, Weeks.gestation.category, ArtLine.Indicator, CVL1.Indicator, ECMO.Indicator, Oxygen.Indicator, Vent.Indicator, IO.Difference.Category, Problem.Count, NPO.Indicator, Birthweight.categories, Parenteral.Nutrition, Albumin.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, C.Reactive.Protein.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, ESR.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, WBC.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, Weaning.Phase, Clonidine.Inter.Indicator, Diazepam.Inter.Indicator, Fentanyl.Inter.Indicator, Lorazepam.Inter.Indicator, Methadone.Inter.Indicator, Morphine.Inter.Indicator, Midazolam.Cont.Indicator, Intermittent.Sedative.Medication.Admin.Count, Major.Region)
#RVAR predicted.se.fit -output -numeric -vector  #Metric Expression: RScript<_RScriptFile="J:\Ashley\ICU Prediction\7N 14 Day Discharge Prediction.R", _InputNames=" Days.Since.Checkin, Last.Bedded.Service.Grouped, Critical.Care.Indicator, Subsequent.Indicator, Cardiovascular.dx.category, CCC.drugs.dx.category, Genetic.dx.category, GI.dx.category, Hem.imm.dx.category, Neonatal.dx.category, Neuro.dx.category, Renal.dx.category, Respiratory.dx.category, Technology.dependent.dx.category, Weeks.gestation.category, ArtLine.Indicator, CVL1.Indicator, ECMO.Indicator, Oxygen.Indicator, Vent.Indicator, IO.Difference.Category, Problem.Count, NPO.Indicator, Birthweight.categories, Parenteral.Nutrition, Albumin.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, C.Reactive.Protein.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, ESR.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, WBC.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, Weaning.Phase, Clonidine.Inter.Indicator, Diazepam.Inter.Indicator, Fentanyl.Inter.Indicator, Lorazepam.Inter.Indicator, Methadone.Inter.Indicator, Morphine.Inter.Indicator, Midazolam.Cont.Indicator, Intermittent.Sedative.Medication.Admin.Count, Major.Region", _WorkingDir="\\BI_ISD\BI_Share\Ashley\ICU Prediction">( Days.Since.Checkin, Last.Bedded.Service.Grouped, Critical.Care.Indicator, Subsequent.Indicator, Cardiovascular.dx.category, CCC.drugs.dx.category, Genetic.dx.category, GI.dx.category, Hem.imm.dx.category, Neonatal.dx.category, Neuro.dx.category, Renal.dx.category, Respiratory.dx.category, Technology.dependent.dx.category, Weeks.gestation.category, ArtLine.Indicator, CVL1.Indicator, ECMO.Indicator, Oxygen.Indicator, Vent.Indicator, IO.Difference.Category, Problem.Count, NPO.Indicator, Birthweight.categories, Parenteral.Nutrition, Albumin.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, C.Reactive.Protein.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, ESR.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, WBC.Result.Most.Recent.or.Unmeasured.on.Bedded.Day, Weaning.Phase, Clonidine.Inter.Indicator, Diazepam.Inter.Indicator, Fentanyl.Inter.Indicator, Lorazepam.Inter.Indicator, Methadone.Inter.Indicator, Morphine.Inter.Indicator, Midazolam.Cont.Indicator, Intermittent.Sedative.Medication.Admin.Count, Major.Region)
...
mstr.ErrMsg <- tryCatch({                                      #tryCatch for Exception Handling
  ...
  if(exists("mstr.ExFlag")) {
    ...
    load("ICUPredictors.7N.14.2017.df.Rda")
